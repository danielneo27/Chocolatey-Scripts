...
- Windows 10 ou 8.
- PowerShell.
- Se não conseguir executar o script com sucesso, talvez seu windows não tenha permissão para execução de scripts, para habilitar execute este comando no powershell *"Set-ExecutionPolicy Bypass -Scope Process"* pressione enter e confirme com "S".
